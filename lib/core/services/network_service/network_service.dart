...
class NetworkService {
  ...
  NetworkService(Client client, {Duration? defaultTimeLimit, RetryOptions? retryPolicy})
      : _defaultTimeLimit = defaultTimeLimit ?? const Duration(seconds: 10),
        _retryPolicy = retryPolicy ?? const RetryOptions(maxAttempts: 3),
        _client = client;

  /// checks whether user has internet connection. this will ping `google.com`.
  ...
  /// checks whether user is connected to any of network type (Mobile or WiFi).
